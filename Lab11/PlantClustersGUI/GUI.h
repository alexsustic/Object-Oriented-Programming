...
private:
	...
	QPushButton* addButton, * deleteButton, * updateButton, * listButton, * fileLocationButton, *modeAButton, *modeBButton, *nextButton, *saveButton, *myListButton, *myListLocationButton;
